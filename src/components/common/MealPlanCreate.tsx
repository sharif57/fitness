...
// import { useCreateNutritionMutation } from "@/redux/features/nutritionSlice";
// import { useSubscriptionGetQuery } from "@/redux/features/subscriptionSlice";
// import { useRouter } from "next/navigation";
...
export default function MealPlanCreate() {
  ...
  const hasWorkoutSubscription = packageName === "nutrition" && subscriptionStatus;
  const hasBothSubscription =
    packageName === "workout & nutrition" && subscriptionStatus;
  ...
  const handleSendMessage = async () => {
    ...
    if (!inputMessage.trim()) {
      toast.error("Please enter a valid meal plan prompt.");
      return;
    }
